...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype279</identifier>
    ...
    <motetype>
      ...
      <description>CoAPbit</description>
      <source>[CONFIG_DIR]/coapbit/coapbit.c</source>
      <commands>make coapbit.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>91.19243673019957</x>
        <y>87.32712054050117</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype279</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>116.18275553738907</x>
        <y>65.9627983340601</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.120228879212927 0.0 0.0 2.120228879212927 -18.841435739037546 -9.50485644502575</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
